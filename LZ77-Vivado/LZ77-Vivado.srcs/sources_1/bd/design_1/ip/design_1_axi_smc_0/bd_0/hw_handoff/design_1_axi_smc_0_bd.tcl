...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC000_ROUTE {0b010} \
   CONFIG.SSC001_ROUTE {0b100} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_SC_AR_1 [get_bd_intf_pins s01_axi2sc/M_SC_AR] [get_bd_intf_pins s01_nodes/S_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_R_1 [get_bd_intf_pins s01_nodes/S_SC_R] [get_bd_intf_pins switchboards/M01_SC_R]
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins clk_map/S01_ACLK] [get_bd_pins s01_axi2sc/aclk] [get_bd_pins s01_entry_pipeline/aclk] [get_bd_pins s01_nodes/s_sc_clk]
  connect_bd_net -net aclk_2 [get_bd_pins clk_map/S02_ACLK] [get_bd_pins s02_axi2sc/aclk] [get_bd_pins s02_entry_pipeline/aclk] [get_bd_pins s02_nodes/s_sc_clk]
  ...
  connect_bd_net -net aresetn_2 [get_bd_pins clk_map/S01_ARESETN] [get_bd_pins s01_entry_pipeline/aresetn] [get_bd_pins s01_nodes/s_sc_resetn]
  connect_bd_net -net aresetn_3 [get_bd_pins clk_map/S02_ARESETN] [get_bd_pins s02_entry_pipeline/aresetn] [get_bd_pins s02_nodes/s_sc_resetn]
  ...
  connect_bd_net -net swbd_aclk_net [get_bd_pins clk_map/swbd_aclk] [get_bd_pins m00_nodes/s_axi_aclk] [get_bd_pins s01_nodes/m_sc_clk] [get_bd_pins s02_nodes/m_sc_clk] [get_bd_pins switchboards/aclk]
  connect_bd_net -net swbd_aresetn_net [get_bd_pins clk_map/swbd_aresetn] [get_bd_pins m00_nodes/s_axi_aresetn] [get_bd_pins s01_nodes/m_sc_resetn] [get_bd_pins s02_nodes/m_sc_resetn] [get_bd_pins switchboards/aresetn]
