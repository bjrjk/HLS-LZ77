// ==============================================================
// File generated on Mon Mar 22 17:38:28 +0800 2021
...
typedef struct {
    ...
    XLz77_uio_map maps[ MAX_UIO_MAPS ];
} XLz77_uio_info;

/***************** Variable Definitions **************************************/
static XLz77_uio_info uio_info;
...
static int uio_info_read_name(XLz77_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XLz77_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XLz77_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XLz77_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XLz77_Initialize(XLz77 *InstancePtr, const char* InstanceName) {
	XLz77_uio_info *InfoPtr = &uio_info;
